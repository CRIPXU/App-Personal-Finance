...
class ChartLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    eModel.add(ExpensesModel(
        day: 0, expense: 0.0)); // Para indicarle a la grafica que empiece en 0
    eModel.sort(
        (a, b) => a.day.compareTo(b.day)); // es para ordenar grafíco por dias
    ...
    print(currentDay);
    perDayList = List.generate(currentDay, (int i) {
      return eList
          .where((e) => e.day == (i))
          .map((e) => e.expense)
          .fold(0.0, (a, b) => a + b);
...
class SymboLRender extends charts.CircleSymbolRenderer {
  ...
  void paint(charts.ChartCanvas canvas, Rectangle<num> bounds,
    ...
    canvas.drawRect(
        Rectangle(bounds.left - 25, bounds.top - 30, bounds.width + 50,
            bounds.height + 18),
