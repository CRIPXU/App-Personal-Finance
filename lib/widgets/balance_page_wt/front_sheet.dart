    ...
    return Container(
      ...
      ListView(
        ...
        children: const [
          ...
          FlayerSkin(myTitle: 'Frecuencia de Gastos', myWidget: FlayerFrecuency()),
          FlayerSkin(myTitle: 'Movimientos', myWidget: FlayerMoviments()),
          FlayerSkin(myTitle: 'Balance General', myWidget: FlayerBalance()),
        ]
      )
      :
      Column(
